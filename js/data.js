...
const MENU_ITEMS = [
  ...
  { id: 6,   name: "BABYCORN MACHURIYAN",    category: "veg-starters", price: 180, isVeg: true,  isBestseller: false, isPopular: false, description: "Crispy baby corn tossed in soy-Manchurian glaze.", image: "images/gobi_manchurian.png" },
  ...
  // ==================== VEG GRAVY ====================
  { id: 37,  name: "KAJU MASALA",           category: "veg-curry", price: 220, isVeg: true,  isBestseller: true,  isPopular: true,  description: "Golden roasted cashews cooked in rich creamy onion gravy.", image: "images/kaju_fry.png" },
  { id: 38,  name: "KAJU PANEER",           category: "veg-curry", price: 220, isVeg: true,  isBestseller: true,  isPopular: true,  description: "Rich combination of roasted cashews and fresh cottage cheese.", image: "images/paneer.png" },
  { id: 39,  name: "KAJU TOMOTO CURRY",     category: "veg-curry", price: 200, isVeg: true,  isBestseller: false, isPopular: false, description: "Cashews and tomatoes cooked together in a tangy curry.", image: "images/kaju_fry.png" },
  ...
  { id: 41,  name: "MENTHI CHAMAN",         category: "veg-curry", price: 200, isVeg: true,  isBestseller: false, isPopular: false, description: "Grated paneer cooked with fresh fenugreek leaves and cream.", image: "images/paneer.png" },
  { id: 42,  name: "PANEER BUTTER MASALA",  category: "veg-curry", price: 200, isVeg: true,  isBestseller: true,  isPopular: true,  description: "Soft cottage cheese cooked in creamy tomato butter gravy.", image: "images/paneer.png" },
  { id: 43,  name: "PALAK PANNER",          category: "veg-curry", price: 200, isVeg: true,  isBestseller: false, isPopular: true,  description: "Paneer cubes cooked in a smooth spiced spinach purée.", image: "images/paneer.png" },
  { id: 44,  name: "MIX VEG CURRY",         category: "veg-curry", price: 180, isVeg: true,  isBestseller: false, isPopular: false, description: "Fresh seasonal vegetables cooked in a spiced curry base.", image: "images/paneer.png" },
  { id: 45,  name: "PLANE PALAK",           category: "veg-curry", price: 120, isVeg: true,  isBestseller: false, isPopular: false, description: "Fresh spinach purée cooked with traditional spices.", image: "images/paneer.png" },
  { id: 46,  name: "TOMOTO CURRY",          category: "veg-curry", price: 120, isVeg: true,  isBestseller: false, isPopular: false, description: "Tangy tomato pieces cooked with spices.", image: "images/paneer.png" },
  { id: 47,  name: "DAL FRY",               category: "veg-curry", price: 120, isVeg: true,  isBestseller: false, isPopular: true,  description: "Yellow lentils cooked with onions, tomatoes, and garlic.", image: "images/paneer.png" },
  { id: 48,  name: "DAL TADKA",             category: "veg-curry", price: 120, isVeg: true,  isBestseller: false, isPopular: false, description: "Dal tempered with spices, ghee, and roasted cumin.", image: "images/paneer.png" },
  { id: 49,  name: "MALAI KOPTHA CURRY",    category: "veg-curry", price: 200, isVeg: true,  isBestseller: true,  isPopular: true,  description: "Crispy vegetable dumplings cooked in rich creamy spiced gravy.", image: "images/paneer.png" },
